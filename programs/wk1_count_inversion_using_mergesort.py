...
#        second_half = alist[mid:]
#
#        count_inversion_using_mergesort(first_half, count)
#        count_inversion_using_mergesort(second_half, count)
#
#        i = 0
#        j = 0
#        k = 0
...
#for i in range(100000):
#    A.append(int(Array.readline()))
#count_inversion_using_mergesort(A, count[0])
#print 'the first 20 elements of list become %s and total inversion count is %s' % (A[:20], count)
